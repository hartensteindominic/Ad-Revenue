...
function TwinExperience(){
  ...
  return <main className="vv-twinPage">
    ...
    <section className="vv-twinStage">
      ...
      <div className="vv-twinViewer"><Product3DTwin item={resolved} hero nftMode /></div>
    ...
    <section className="vv-twinInfo"><div><small>WHAT YOU ARE COLLECTING</small><h2>A real 3D collectible, not a flat product card.</h2></div><p>This page is the permanent interactive presentation target for the Voxel Vault NFT. The storefront may show an exact published model viewer for product inspection, but the mintable experience uses Voxel Vault's own original procedural twin geometry so the NFT does not depend on embedding a third-party viewer.</p></section>
