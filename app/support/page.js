    ...
    <main className="supportPage">
      <div className="supportShell">
        ...
        <div className="supportGrid">
          <article><b>Wallet problems</b><p>Make sure your wallet is on the network shown by the app. Never send your recovery phrase or private key to support.</p></article>
          <article><b>3D not loading</b><p>On iPhone, passive gallery previews are intentionally lightweight. Open an object to request its interactive inspection view.</p></article>
          <article><b>Purchase or claim issue</b><p>Keep your transaction hash or checkout receipt. Do not retry a transaction repeatedly if the first one is still pending.</p></article>
          <article><b>Privacy request</b><p>Use the support contact below for questions about information held by Voxel Vault or requests to delete eligible account data.</p></article>
        </div>
        <div className="contact"><span>SUPPORT CONTACT</span><a href="mailto:support@voxel-vault.vercel.app">support@voxel-vault.vercel.app</a><small>Replace this placeholder address with the final support mailbox before App Store submission.</small></div>
