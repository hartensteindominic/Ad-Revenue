  ...
  return (
    <main style={{ minHeight: '100vh', background: '#070912', color: '#eef0f7', padding: '24px 18px', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <section style={sectionStyle}><h2>Third parties</h2><p style={textStyle}>Blockchain networks, wallet providers, hosting, analytics, payments, storage, and other integrations may process information under their own policies.</p></section>
