  ...
  return (
    <main className="legalPage">
      <div className="legalShell">
        ...
        <section><h2>What we may process</h2><ul><li>Wallet addresses when you choose to connect a wallet or complete a blockchain action.</li><li>Transaction and collectible information needed to show ownership, purchases, claims and marketplace activity.</li><li>Information you voluntarily submit through support, creator or checkout flows.</li><li>Technical request information needed to secure and operate the service, such as timestamps, request metadata and limited diagnostics.</li><li>Payment information is handled by our payment provider rather than stored as raw card details by Voxel Vault.</li></ul></section>
        <section><h2>Why we use it</h2><p>We use information to operate the Vault, process requested transactions, prevent abuse, provide support, improve reliability, and maintain security. We do not require an account simply to browse the public collection.</p></section>
        ...
        <section><h2>Wallets and blockchain data</h2><p>Blockchain transactions are public and may be permanently visible on the relevant network. Connecting a wallet does not give Voxel Vault access to your private keys or seed phrase.</p></section>
        <section><h2>Choices and deletion</h2><p>You can browse without creating an account. You can disconnect a wallet at any time through your wallet software. For questions, data requests or deletion requests involving information held by Voxel Vault, contact support through the Support page.</p></section>
