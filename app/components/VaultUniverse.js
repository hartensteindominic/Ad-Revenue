...
export default function VaultUniverse() {
  ...
  useEffect(() => {
    ...
    const sync = () => { const mobile = mq.matches; setIsMobile(mobile); if (!selected) setActive3D('hero'); };
  ...
  const closeInspect = () => { setSelected(null); setActive3D('hero'); };
