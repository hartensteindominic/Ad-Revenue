...
const items = [
  { icon: '👟', name: 'Your first collectible', meta: 'Verified purchase · Ready for 3D' },
  { icon: '☕', name: 'Coffee memory', meta: 'Purchase collectible · Aug 2026' },
  { icon: '🧸', name: 'Physical object', meta: 'NFT + QR · Provenance attached' },
];
