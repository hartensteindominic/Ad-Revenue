...
export function validateSponsoredCollectible(input = {}) {
  ...
  if (!cleanText(input.campaignId, 96)) errors.push('campaignId is required');
...
export const SPONSOR_READY_CONCEPTS = [
  {
    ...
    campaignId: 'concept-3d-artifact',
  ...
  },
  {
    ...
    campaignId: 'concept-creator-collab',
