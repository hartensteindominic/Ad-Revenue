...
/**
 * Mint a collectible to the connected wallet via NFT.mint.
 * Pays gas in ETH on the configured chain (default Sepolia). No mint fee in the contract itself.
 */
...
/** Mint and list for sale in ETH via marketplace. */
...
/** Peer transfer of an owned token (gas in ETH). */
...
/** Place an ETH offer on a token via marketplace (msg.value in ETH). */
