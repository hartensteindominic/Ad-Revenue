...
export function createDefaultHunts() {
  return [
    ...
    createHunt({
      id: 'hunt-neon-night-circuit',
      name: 'Neon Night Circuit',
      description: 'A stylized city loop. Same artifacts, new clues — race the glow.',
      mode: 'unordered',
      difficulty: 'hard',
      estimatedMinutes: 35,
      status: 'active',
      stops: [
        {
          ...
          type: 'drop',
          title: 'Cyan Lens',
          clue: 'Under violet sky — catch the cyan glint.',
          dropId: 'drop-field-camera-001',
          lat: 40.758,
          lng: -73.9855,
          radiusMeters: 100,
        },
        {
          ...
          type: 'drop',
          title: 'Pulse Scout',
          clue: 'Listen for the servo tick in the square.',
          dropId: 'drop-survey-robot-001',
          lat: 40.7411,
          lng: -73.9897,
          radiusMeters: 110,
        },
        {
          ...
          type: 'drop',
          title: 'Midnight Deck',
          clue: 'Wheels on wet pavement — last leg.',
          dropId: 'drop-street-deck-001',
          lat: 34.043,
          lng: -118.2673,
          radiusMeters: 130,
      ...
      reward: {
        name: 'Neon Circuit Crest',
        family: 'artifacts',
        subtype: 'badge',
        rarity: 'legendary',
        description: 'Cleared the Neon Night Circuit',
      },
    }),
  ];
}
