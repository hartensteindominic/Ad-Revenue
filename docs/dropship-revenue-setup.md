...
The storefront can display a published third-party 3D viewer for product inspection, while the mintable NFT experience uses Voxel Vault's own procedural 3D twin.
