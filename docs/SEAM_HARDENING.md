...
- sponsor metadata pointing to an unsafe destination
- campaign rewards exceeding funded allocations

## Product boundary

The 3D collectible remains the product. Physical discovery, wallet ownership, marketplace settlement, sponsorship and AI curation exist to strengthen the discovery-to-ownership loop rather than become separate products.
